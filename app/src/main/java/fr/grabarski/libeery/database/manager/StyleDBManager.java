...
public class StyleDBManager {
    ...
    public void insert(int id, String name, Date createDate, String shortName, String description, float ibuMin, float ibuMax, float abvMin, float abvMax, float srmMin, float srmMax, float ogMin, float fgMin, float fgMax, Date updateDate){
    ...
    public int update(long _id, String name, Date createDate, String shortName, String description, float ibuMin, float ibuMax, float abvMin, float abvMax, float srmMin, float srmMax, float ogMin, float fgMin, float fgMax, Date updateDate){
        ContentValues contentValues = new ContentValues();
        contentValues.put(DatabaseHelper.NAME, name);
        contentValues.put(DatabaseHelper.CREATE_DATE, Constant.DATE_FORMAT.format(createDate));
        contentValues.put(DatabaseHelper.SHORT_NAME, shortName);
        ...
        if (cursor != null) {
            if (cursor.moveToFirst()) {
                do {
                    ...
                    styles.add(new Style(id, name, createDate, shortName, description, ibuMin, ibuMax, abvMin, abvMax, srmMin, srmMax, ogMin, fgMin, fgMax, updateDate));
